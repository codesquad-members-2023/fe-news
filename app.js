...
import ListSubView from './src/js/view/listSubView.js';
import ListSubButtonView from './src/js/view/listSubButtonView.js';
...
new ListSubView(NSSectionCurViewModel);
new ListSubButtonView(NSSectionCurViewModel);
